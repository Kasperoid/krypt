...
class entry:
    """Вычисление хэш-функции по алгоритму ГОСТ 34.11"""
...
class SenderWindow:
    ...
    def sign(self):
        ...
        if message == '':
            ...
            for i in range(100):
                check = existInverse(message, q, p, xp, yp, a)
            ...
            r, s, self.hash_message = sign(d, message, q, xp, yp, a, p)
    ...
    def verify(self):
        ...
        if (message.strip() != self.messagePoluch.strip()):
            ...
            isCheck, hash_text = verif(message, r, s, q, p, xp, yp, a, xq, yq)
...
class ReceiverWindow:
    ...
    def sign(self):
        ...
        if message == '':
            ...
            r, s, self.hash_sum = sign(d, message, q, xp, yp, a, p)
